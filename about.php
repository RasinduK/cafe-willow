  ...
  <!-- <div class="heading">
   ...
   <section class="about">
      ...
      <div class="row">
         ...
         <div class="content">
            <h3>Our Mission</h3>
            <p>Cafe Willow started with a simple mission:</p>
            <br>
            <br>
            <p> Cafe Willow started with a simple mission: to bring together the best of fresh ingredients, great coffee, and a cozy atmosphere for people to gather and enjoy. We pride ourselves on our commitment to quality and community.</p>
