            ...
            ?>
                  <div class="swiper-slide slide">
                     ...
                     <form action="" method="post" class="box">
                        ...
                        <div class="flex">
                           <a style="padding-right: 120px;"><span>LKR </span><?= $fetch_products['price']; ?></a>
                           <input style="border: 2px solid black;" type="number" name="qty" class="qty" min="1" max="9999" value="1" maxlength="2">
            ...
            ?>
                  <div class="swiper-slide slide">
                     ...
                     <form action="" method="post" class="box">
                        ...
                        <div class="flex">
                           <a style="padding-right: 120px;"><span>LKR </span><?= $fetch_products['price']; ?></a>
                           <input style="border: 1px;" type="number" name="qty" class="qty" min="1" max="9999" value="1" maxlength="2">
                           <button type="submit" class="fas fa-shopping-cart" name="add_to_cart"></button>
