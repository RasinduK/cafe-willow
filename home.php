   ...
   <section class="hero">
      ...
      <div class="swiper hero-slider">
         ...
         <div class="swiper-slide slide">
               ...
               <div class="image">
                  <img src="images/home-buger.png" alt="">
               </div>
            </div>
            <div class="swiper-slide slide">
               <div class="content">
  ...
  <!-- <section class="products">
         ...
         ?>
               <form action="" method="post" class="box">
                  ...
                  <div class="flex">
                     ...
                     <input type="number" name="qty" class="qty" min="1" max="9999" value="1" maxlength="2">
                  </div>
               </form>
         <?php
            }
   ...
   <section class="about">
      ...
      <div class="row">
         ...
         <div class="image">
            <img src="images/cafe logo.jpg" alt="">
         </div>

         <div class="content">
            <h3>why choose us?</h3>
            <p>Cafe Willow offers fresh, high-quality dishes, a creative menu, and a welcoming atmosphere. With skilled chefs, friendly service, and a commitment to sustainability, we create memorable dining experiences for every guest.</p>
   ...
   <section class="steps">
      ...
      <div class="box-container">
         ...
         <div class="box">
            ...
            <h3>choose order</h3>
            <p>"Choose your order at Cafe Willow and enjoy delicious dishes crafted just for you!"</p>
         </div>

         <div class="box">
            <img src="images/step-2.png" alt="">
            <h3>fast delivery</h3>
            <p>"Enjoy fast delivery from Cafe Willow, bringing your favorite flavors right to your door!"</p>
         </div>

         <div class="box">
            <img src="images/step-3.png" alt="">
            <h3>enjoy food</h3>
            <p>"Enjoy delicious food at Cafe Willow, crafted to delight your taste buds!"</p>
         </div>
